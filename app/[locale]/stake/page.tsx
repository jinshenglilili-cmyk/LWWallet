...
import { useStakeContract, useTokenContract } from "../../../hook/useContract";
import useRewards from "../../../hook/useRewards";
import { useCallback, useMemo, useState } from "react";
import { Pid } from "../../../untils/index";
...
import { StakeContractAddress } from "../../../untils/env";
...
const Stake = () => {
  ...
  const tokenContract = useTokenContract(
    poolData.stTokenAddress as Address | undefined,
  );
  ...
  return (
    <div className="bg:blue-900 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      <div className="bg:blue-900 grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {/* Stake Card */}
